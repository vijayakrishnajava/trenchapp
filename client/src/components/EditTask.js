...
import { taskGetAction, taskCreateAction, taskEditAction } from './action/taskAction';
...
class EditTask extends React.Component {
	...
	componentDidMount() {
		...
		this.props.taskGetAction(this.props.match.params.identifier,
	...
	onSubmitEvent = (e) => {
		...
		this.props.taskEditAction({summary, acceptanceCriteria, dueDate,priority, status},
		this.props.match.params.identifier, this.props.match.params.seq);
	}
...
export default connect(mapStateTOProps, {taskCreateAction, taskGetAction, taskEditAction,taskStatusListAction,taskPriorityListAction})(EditTask);